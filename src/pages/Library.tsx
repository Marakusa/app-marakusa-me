        ...
        {!archived && !currentProductId && (
          <div className="w-full flex flex-col justify-center items-center bg-gradient-to-tr from-purple-400/90 to-blue-300/90 text-blue-950 font-bold rounded-3xl shadow-lg shadow-black/20 p-8">
            ...
            <div className="flex flex-col lg:flex-row gap-5 mt-5">
              ...
              <a href="https://ferune.com/store/marakusa" target="_blank" className="bg-[url(/ferune-large.png)] bg-cover bg-no-repeat bg-center w-54 h-18 hover:scale-102 rounded-xl border border-blue-300 shadow-lg shadow-black/20"></a>
            </div>
          </div>
        )}
                              ...
                              <div
                                ...
                                onClick={() => {
                                  setPrivateFiles(prev => ({
                                    ...prev,
                                    archivedProducts: prev.archivedProducts.map(p =>
                                      p.id === product.id
                                        ? { ...p, currentDirectory: p.currentDirectory.slice(0, -1) }
                                        : p
                                    )
                                  }));
                                }}
                                ...
                                onClick={() => {
                                  if (file.type === "directory") {
                                    setPrivateFiles(prev => ({
                                      ...
                                      archivedProducts: prev.archivedProducts.map(p =>
                                        p.id === product.id
                                          ? { ...p, currentDirectory: [...p.currentDirectory, index] }
                                          : p
                                      )
                                    }));
                                  } else {
