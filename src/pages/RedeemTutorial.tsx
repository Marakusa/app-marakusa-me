                ...
                <div className="bg-zinc-900 text-white w-full sm:rounded-3xl shadow-lg shadow-black/20 p-8 md:px-16 md:pb-16 text-left">
                    ...
                    <div id="gumroad" className="pt-8">
                        ...
                        <div className="text-left flex flex-col gap-2">
                            ...
                            <div className="bg-yellow-950 border border-yellow-500 p-2 px-3 my-4 rounded-xl font-bold flex flex-row items-center">
                                <IoWarningOutline className="w-20 h-20 sm:w-10 sm:h-10 mr-3 text-yellow-300" />
                                <p>If you are redeeming bundles, choose the bundle from the list and not the included products of the bundle!</p>
                            </div>
